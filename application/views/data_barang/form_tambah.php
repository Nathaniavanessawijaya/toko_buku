...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-cubes"></i> Tambah Data Buku</h4>
    </div>
</div>
<hr class="mt-0" />
<?= form_open(); ?>
<div class="col-md-8">
    ...
    <div class="form-group row">
        <label for="KodeBarang" class="col-sm-3 col-form-label">Kode Buku</label>
    ...
    <div class="form-group row">
        <label for="nama_barang" class="col-sm-3 col-form-label">Nama Buku</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="brand" class="col-sm-3 col-form-label">Jenis Buku</label>
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('brand')) ? 'is-invalid' : ''; ?>" id="brand" name="brand" placeholder="Brand" value="<?= set_value('brand'); ?>">
            <div class="invalid-feedback">
